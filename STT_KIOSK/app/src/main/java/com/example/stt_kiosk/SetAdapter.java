...
import static com.example.stt_kiosk.MainActivity.DB_result_set;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        switch (position){
            case 0:
                int i = 0;
                for(; i < firstIdx; i++){
                    firstPageImg.get(i).setImageResource(context.getResources().getIdentifier(DB_result_set.get(i).get(3), "drawable", "com.example.stt_kiosk"));
            ...
            case 1:
                ...
                int j = 0;
                for(; j < secondIdx; j++) {
                    secondPageImg.get(j).setImageResource(context.getResources().getIdentifier(DB_result_set.get(j + 9).get(3), "drawable", "com.example.stt_kiosk"));
                    secondPageName.get(j).setText(DB_result_set.get(j + 9).get(1));
                    secondPagePrice.get(j).setText(formatter.format(Integer.parseInt(DB_result_set.get(j + 9).get(2))) + "원");
                }
                for(; j < 9; j++){
            ...
            case 2:
                ...
                int k = 0;
                for(; k < thirdIdx; k++) {
                    thirdPageImg.get(k).setImageResource(context.getResources().getIdentifier(DB_result_set.get(k + 18).get(3), "drawable", "com.example.stt_kiosk"));
                    thirdPageName.get(k).setText(DB_result_set.get(k + 18).get(1));
                    thirdPagePrice.get(k).setText(formatter.format(Integer.parseInt(DB_result_set.get(k + 18).get(2))) + "원");
                }
                for(; k < 9; k++){
